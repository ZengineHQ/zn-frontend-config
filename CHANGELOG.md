...
* email input ([1bfab0f](https://github.com/ZengineHQ/zn-frontend-config/commit/1bfab0f))



<a name="3.16.0"></a>
# [3.16.0](https://github.com/ZengineHQ/zn-frontend-config/compare/3.15.0...3.16.0) (2019-10-03)


### Features

* support belongsTo for custom field types ([2fc1316](https://github.com/ZengineHQ/zn-frontend-config/commit/2fc1316))
...
<a name="3.11.2"></a>
## [3.11.2](https://github.com/ZengineHQ/zn-frontend-config/compare/3.11.1...3.11.2) (2019-04-11)
...
* filter.value undefined when using subfilters ([e84bdf7](https://github.com/ZengineHQ/zn-frontend-config/commit/e84bdf7))
...
* populate dropdown w/ existing values ([281ebd9](https://github.com/ZengineHQ/zn-frontend-config/commit/281ebd9))
...
* choices added to the appropriate property ([fb55483](https://github.com/ZengineHQ/zn-frontend-config/commit/fb55483))
* copy-paste mistake ([4759ef4](https://github.com/ZengineHQ/zn-frontend-config/commit/4759ef4))


### Features

* fetch 200+ fields ([ec0c5b2](https://github.com/ZengineHQ/zn-frontend-config/commit/ec0c5b2))
* get all folders ([aaadf5b](https://github.com/ZengineHQ/zn-frontend-config/commit/aaadf5b))
* get all folders v2 ([b6d2c06](https://github.com/ZengineHQ/zn-frontend-config/commit/b6d2c06))


### Performance Improvements

* store arrays in variables and only call functions on focus ([fa221b2](https://github.com/ZengineHQ/zn-frontend-config/commit/fa221b2))
...
* fields not being initialized for single config ([9d2476f](https://github.com/ZengineHQ/zn-frontend-config/commit/9d2476f)), closes [/github.com/ZengineHQ/zn-frontend-config/blob/master/src/main.controller.js#L282](https://github.com//github.com/ZengineHQ/zn-frontend-config/blob/master/src/main.controller.js/issues/L282)
* using multiple instances of config directive ([594379d](https://github.com/ZengineHQ/zn-frontend-config/commit/594379d))
...
* button doesnt overlap anymore resolves [#20](https://github.com/ZengineHQ/zn-frontend-config/issues/20) ([a20546e](https://github.com/ZengineHQ/zn-frontend-config/commit/a20546e))
* fixes https://github.com/ZengineHQ/zn-frontend-config/issues/10 ([d056796](https://github.com/ZengineHQ/zn-frontend-config/commit/d056796))
* immutability ([26d1b66](https://github.com/ZengineHQ/zn-frontend-config/commit/26d1b66))
* no lets! ([dc9f40a](https://github.com/ZengineHQ/zn-frontend-config/commit/dc9f40a))
* resolve vulnerabilities (npm audit fix) ([ca2be15](https://github.com/ZengineHQ/zn-frontend-config/commit/ca2be15))
* show existing dropdown values as selected ([4f6f47b](https://github.com/ZengineHQ/zn-frontend-config/commit/4f6f47b))
* show form field name if exists, o/w label ([b31b50b](https://github.com/ZengineHQ/zn-frontend-config/commit/b31b50b))
* skip id/name validation for markup type ([ed83cea](https://github.com/ZengineHQ/zn-frontend-config/commit/ed83cea))
* variable scope collision ([448c30d](https://github.com/ZengineHQ/zn-frontend-config/commit/448c30d))
* webhook filters update when config is re-saved ([077384b](https://github.com/ZengineHQ/zn-frontend-config/commit/077384b))


### Features

* add min/max attribute to number input ([8042af0](https://github.com/ZengineHQ/zn-frontend-config/commit/8042af0))
* add minlength/maxlength to text input ([7518a21](https://github.com/ZengineHQ/zn-frontend-config/commit/7518a21))
* callback to conditionally show/hide fields ([cf33716](https://github.com/ZengineHQ/zn-frontend-config/commit/cf33716))
* new choice mode 'multi-select' ([3f664e1](https://github.com/ZengineHQ/zn-frontend-config/commit/3f664e1))
* step attribute resolves [#1](https://github.com/ZengineHQ/zn-frontend-config/issues/1) ([507cb71](https://github.com/ZengineHQ/zn-frontend-config/commit/507cb71))
* webhook filter prefixes can be user-configured ([e3eeca9](https://github.com/ZengineHQ/zn-frontend-config/commit/e3eeca9))
* webhook method can receive filter parameter ([7f236a3](https://github.com/ZengineHQ/zn-frontend-config/commit/7f236a3))
