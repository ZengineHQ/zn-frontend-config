(function (angular) {
	...
	angular.module('znFrontendMultiConfig').service('zpMultiSettingsSrv', ['$q', '$firebase', 'znData',
		function ($q, $firebase, znData) {
			 ...
			 */
			var loadPlugin = function (namespace) {
				var q = $q.defer();
			 ...
			 * @return {Promise<Object>} Plugin settings.
			 */
			srv.load = function (namespace, workspaceId) {
				return loadPlugin(namespace).then(function (plugin) {
